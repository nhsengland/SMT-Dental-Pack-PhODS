...
#group data for further calculation is needed
  if(all_regions_and_STPs == FALSE){
...
#calculate no or unique patient seen for general/adult/child  
  new_data <- new_data %>% 
