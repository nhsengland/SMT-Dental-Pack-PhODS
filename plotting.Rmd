  ...
  if(plotChart == TRUE){
    ...
    if(UDAorUOA == "UDA"){
      new_col_names <- c(`Calendar month` = "month",
                         ...
                         `Monthly UDAs Band1 delivered` = "monthly_UDA_UOAs_BAND1_delivered",
                         `Monthly UDAs Band2 delivered` = "monthly_UDA_UOAs_BAND2_delivered",
                         `Monthly UDAs Band3 delivered` = "monthly_UDA_UOAs_BAND3_delivered",
                         `Monthly UDAs Band Urgent delivered` = "monthly_UDA_UOAs_BAND_URGENT_delivered",
                         `Monthly UDAs Band Other delivered` = "monthly_UDA_UOAs_BAND_OTHER_delivered",
                         `Monthly UDAs total delivered` = "monthly_UDA_UOAs_delivered",
