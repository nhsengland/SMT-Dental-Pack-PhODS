...
# these will need manually updating once a year when we get data for the new financial year
current_fy_start <- "2024-04-01"
current_fy_end <- "2025-03-01"
current_fy <- "2024/25"
previous_fy_start <- "2023-04-01"
previous_fy_end <- "2024-03-01"
previous_fy <- "2023/24"
