...
This pack will continue to evolve and change, any questions/comments should be directed to [england.primarycare.phodsdata\@nhs.net](mailto:england.primarycare.phodsdata@nhs.net){.email}
...
-   Implications of not reaching target delivery at the end of the financial year can be understood via <https://faq.nhsbsa.nhs.uk/knowledgebase/article/KA-01672/en-us>
...
plot_monthly_uda_delivered(data = UDA_calendar_data, 
                           level = "National", 
                           region_STP_name = NULL)
```
...
```{r npp activity, echo = FALSE, warning = FALSE, message = FALSE, fig.with=14, fig.height=5, fig.align='center'}
...
```{r npp contracts, echo = FALSE, warning = FALSE, message = FALSE, fig.with=14, fig.height=5, fig.align='center'}
