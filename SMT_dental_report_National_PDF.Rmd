...
n_contracts_uoa <- prettyNum(n_distinct(UOA_calendar_data$contract_number[UOA_calendar_data$month == latest_final_month]),
                             big.mark = ",")
...
-   Count of dental contracts included: `r n_contracts_uda`.
...
-   Count of orthodontic contracts included: `r n_contracts_uoa`.
