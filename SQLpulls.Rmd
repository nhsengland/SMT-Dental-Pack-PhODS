...
UDA_calendar_data<-UDA_calendar_data%>%
  mutate(general_FP17s=sum(band_1_delivered,band_2_delivered,band_3_delivered,band_urgent_delivered,band_other_delivered, na.rm = TRUE))%>%
...
DCP_data <- DCP_data %>%
  mutate(FP17_Current_Year_total =sum(`BAND_1_DELIVERED`,BAND_2_DELIVERED,BAND_3_DELIVERED,BAND_URGENT_DELIVERED,BAND_OTHER_DELIVERED, na.rm = TRUE))%>%
