...
#exclude those with UDA target less than 1
...
#exclude those with UDA target less than 1 then rename fields
...
UDA_calendar_data_FD_only$commissioner_name <- substr(UDA_calendar_data_FD_only$commissioner_name,1,
                                                      nchar(UDA_calendar_data_FD_only$commissioner_name)-3)
...
UDA_calendar_data_FD_only <- UDA_calendar_data_FD_only %>%
  select(month, commissioner_ods_code_icb, commissioner_name, contract_number, child_12m_count,
         adult_24m_count, FP17s_band_1, FP17s_band_2, FP17s_band_2a, FP17s_band_2b, FP17s_band_2c,
...
# join FD only to UDA without FD and calculate total for UDA with FDs
UDA_calendar_data_FD <- UDA_calendar_data %>%
  ...
  select(final_yn, month, commissioner_ods_code_icb, commissioner_name, contract_number, name_or_company_name, 
         contract_type, ppc_address_postcode, lsoa11_code, annual_contracted_UDA, uda_fin_val, 
         general_dental_fin_value, UDA_delivered, FP17s_band_1, FP17s_band_2, FP17s_band_3, FP17s_band_urgent, 
...
```{r UOA - NOT CURRENTLY IN USE}
# function not currently in use as UOA data not yet available
...
# only include contracts in contractual dataset
