...
UDA_calendar_data<-UDA_calendar_data%>%
  mutate(general_FP17s=rowSums(select(., band_1_delivered, band_2_delivered, band_3_delivered, band_urgent_delivered, band_other_delivered), na.rm = TRUE))%>%
...
UDA_calendar_data_FD <- UDA_calendar_data%>%
  ...
  rowwise() %>% 
  mutate(UDA_delivered = coalesce(UDA_delivered.x, 0) + coalesce(UDA_delivered.y, 0),
    FP17s_band_1 = coalesce(FP17s_band_1.x, 0) + coalesce(FP17s_band_1.y, 0),
    FP17s_band_2 = coalesce(FP17s_band_2.x, 0) + coalesce(FP17s_band_2.y, 0),
    FP17s_band_3 = coalesce(FP17s_band_3.x, 0) + coalesce(FP17s_band_3.y, 0),
    FP17s_band_urgent = coalesce(FP17s_band_urgent.x, 0) + coalesce(FP17s_band_urgent.y, 0),
    FP17s_band_other = coalesce(FP17s_band_other.x, 0) + coalesce(FP17s_band_other.y, 0),
    child_12m_count = coalesce(child_12m_count.x, 0) + coalesce(child_12m_count.y, 0),
    adult_24m_count = coalesce(adult_24m_count.x, 0) + coalesce(adult_24m_count.y, 0),
    FP17s_band_2a = coalesce(FP17s_band_2a.x, 0) + coalesce(FP17s_band_2a.y, 0),
    FP17s_band_2b = coalesce(FP17s_band_2b.x, 0) + coalesce(FP17s_band_2b.y, 0),
    FP17s_band_2c = coalesce(FP17s_band_2c.x, 0) + coalesce(FP17s_band_2c.y, 0),
    UDA_band_1 = coalesce(UDA_band_1.x, 0) + coalesce(UDA_band_1.y, 0),
    UDA_band_2 = coalesce(UDA_band_2.x, 0) + coalesce(UDA_band_2.y, 0),
    uda_band_2a_delivered = coalesce(uda_band_2a_delivered.x, 0) + coalesce(uda_band_2a_delivered.y, 0),
    uda_band_2b_delivered = coalesce(uda_band_2b_delivered.x, 0) + coalesce(uda_band_2b_delivered.y, 0),
    uda_band_2c_delivered = coalesce(uda_band_2c_delivered.x, 0) + coalesce(uda_band_2c_delivered.y, 0),
    UDA_band_3 = coalesce(UDA_band_3.x, 0) + coalesce(UDA_band_3.y, 0),
    UDA_urgent = coalesce(UDA_urgent.x, 0) + coalesce(UDA_urgent.y, 0),
    UDA_other = coalesce(UDA_other.x, 0) + coalesce(UDA_other.y, 0)) %>% 
  select(final_yn, month, commissioner_ods_code_icb, commissioner_name, contract_number, name_or_company_name, contract_type, ppc_address_postcode, lsoa11_code, annual_contracted_UDA, uda_fin_val, general_dental_fin_value, UDA_delivered, FP17s_band_1, FP17s_band_2, FP17s_band_3, FP17s_band_urgent, FP17s_band_other, child_12m_count, adult_24m_count, FP17s_band_2a, FP17s_band_2b, FP17s_band_2c, UDA_band_1, UDA_band_2, uda_band_2a_delivered, uda_band_2b_delivered, uda_band_2c_delivered, UDA_band_3, UDA_urgent, UDA_other)
...
DCP_data = DCP_data%>%
  ...
  filter(DCP_DESC!="")%>%
  filter(!is.na(DCP_DESC))

DCP_data <- DCP_data %>%
  mutate(FP17_Current_Year_total =rowSums(select(., BAND_1_DELIVERED, BAND_2_DELIVERED, BAND_3_DELIVERED, BAND_URGENT_DELIVERED, BAND_OTHER_DELIVERED), na.rm = TRUE))%>%
