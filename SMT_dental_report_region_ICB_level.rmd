...
.panel[.panel-name[`r region`]
```{r echo = FALSE, warning = FALSE, message = FALSE, fig.width=14, fig.height=5,eval=FALSE}
...
-   DCP data will be re-instated next month. 
 
-   We have removed this metric this month whilst we assess how to best display the data given that since April 2024 reporting against DCPs being able to both lead and assist in dental care came into force
]
